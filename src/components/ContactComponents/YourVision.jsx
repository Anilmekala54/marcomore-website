  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-360 mx-auto w-[90%] py-20">
        <div className="flex flex-col gap-2  xl:gap-6 items-center relative justify-center">
          <h2 className="text-[22px] lg:text-[54px] font-semibold text-center">
         Let’s get started with Marcamor
          </h2>
...
"
          >
            <img
              src={contactLogo}
              alt="logo"
              className="w-full h-full object-contain absolute top-7 lg:top-0"
            />
          </div>
